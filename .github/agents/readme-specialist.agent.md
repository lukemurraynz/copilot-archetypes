...
tools: [ "search", "edit", "iseplaybook/*", "context7/*", "read", "list"]
---
...
**IMPORTANT**: Use the `iseplaybook` MCP server to get the latest documentation best practices. Use `context7` MCP server for technology-specific documentation patterns. Do not assume—verify current guidance.
...
**Purpose**: Guide users through specific tasks and problems
**Characteristics**:
- Goal-oriented
- Practical steps
...
**Purpose**: Clarify and illuminate concepts and design decisions
**Characteristics**:
...
|--------------------|---------|----------|---------|-------|
| Tutorials | ✅/❌ | ✅/⚠️/❌ | [Rating] | [Comments] |
| How-To Guides | ✅/❌ | ✅/⚠️/❌ | [Rating] | [Comments] |
| Reference | ✅/❌ | ✅/⚠️/❌ | [Rating] | [Comments] |
| Explanation | ✅/❌ | ✅/⚠️/❌ | [Rating] | [Comments] |
